...
const AboutUs = () => {
    return (
        <div className="h-80 bg-swirl -mx-[50%] bg-black flex flex-col gap-6 justify-center object-cover">
            ...
            <span className="text-white text-center block font-jbMono text-3xl">gapc 2024</span>
            <span className="text-white text-center block font-jbMono text-base">Made with ❤️ by FCG</span>
        </div >
    )
}
